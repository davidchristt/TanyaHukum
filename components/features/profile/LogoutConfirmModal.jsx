...
export default function LogoutConfirmModal({ isOpen, onClose, onConfirm }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm mx-4 bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.3)] p-8 text-center transform transition-all animate-in zoom-in-95 duration-300 border border-transparent dark:border-slate-800"
      ...
      >
        ...
        <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Keluar Akun?</h3>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            onClick={onClose}
            className="w-full py-4 bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-500 dark:text-gray-400 font-bold rounded-2xl transition-all active:scale-[0.98]"
          >
            Batal
          </button>
        </div>
